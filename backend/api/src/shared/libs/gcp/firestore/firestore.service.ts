...
import { FirestoreDocumentNotFoundException, FirestoreDocumentsCollectionEmptyException } from "./firestore.exception";
...
export class FirestoreService {
    ...
    async getById(collection: string, id: string): Promise<IFirestoreDocument> {
    ...
    async add(collection: string, data: any): Promise<IFirestoreDocument> {
    ...
    async update(collection: string, id: string, data: any, clean = true): Promise<IFirestoreDocument> {
        const ref = this.getReference(collection);
