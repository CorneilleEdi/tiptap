<template>
  <v-app class="primary darken-2 primary--text darken-2--text">
    <v-container fluid fill-height>
      <v-layout align-center justify-center>
        <v-flex xs12 sm8 md6 lg4>
          <v-card class="elevation-1">
            <v-card-title class="font-weight-bold primary_dark--text title"
              >Welcome on <span class="success--text ml-1"> TipTap</span>
            </v-card-title>

            <v-card-subtitle>Connect to continue</v-card-subtitle>
            ...
            <v-card-text>
              <v-form ref="form" v-model="valid">
                ...
                <v-btn
                  class="white--text subtitle-1 mb-2 pt-0"
                  block
                  large
            ...
            <v-card-text class="pb-2"
              ><p>By sign up, you agree to the terms of service and privacy policy.</p></v-card-text
            >
          </v-card>
        </v-flex>
      </v-layout>
